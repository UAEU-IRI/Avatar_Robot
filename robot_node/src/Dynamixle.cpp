...
void Dynamixle::writePosition(int ID,float angle){
			...
			unsigned char packet[14]= {0xFF,0xFF,0xFD,0x00,ID,9,0x00,0x03,0x74,0,angle_L,angle_H,0x00,0x00};
			unsigned short crc = Dynamixle::update_crc(0,packet,14);
			unsigned char crc_L = crc;
			unsigned char crc_H = (crc>>8);			
			char output_buffer[16] ={0xFF,0xFF,0xFD,0x00,ID,9,0x00,0x03,0x74,0,angle_L,angle_H,0x00,0x00,crc_L,crc_H};
